//! Local runtime benchmark scenarios.

use super::*;

/// Provider-free timings for runtime and write-path primitives.
pub(super) struct RuntimeBenchmarkTimings {
    pub(super) prepare_head_turn: Duration,
    pub(super) pending_tool_approval_scan: Duration,
    pub(super) tool_result_insert: Duration,
    pub(super) deny_tool_result_persist: Duration,
    pub(super) splice_remove: Duration,
    pub(super) truncate: Duration,
    pub(super) context_build_after_tool_chain: Duration,
    pub(super) path_load_100: Duration,
    pub(super) path_load_1000: Duration,
    pub(super) pending_tool_approval_scan_long_path: Duration,
    pub(super) pending_tool_approval_scan_deep_chain: Duration,
    pub(super) prepare_run_head_no_tools: Duration,
    pub(super) prepare_run_head_completed_tool_chain: Duration,
    pub(super) prepare_run_head_requires_approval: Duration,
    pub(super) prepare_run_head_policy_denied: Duration,
    pub(super) splice_remove_branch_point: Duration,
    pub(super) splice_remove_root_many_children: Duration,
    pub(super) splice_remove_tool_group: Duration,
    pub(super) truncate_large_subtree: Duration,
    pub(super) context_build_plain_100: Duration,
    pub(super) context_build_plain_1000: Duration,
    pub(super) context_build_with_system_prompt: Duration,
    pub(super) context_build_with_compaction: Duration,
    pub(super) context_build_with_image_parts: Duration,
    pub(super) provider_tool_attach_load: Duration,
    pub(super) fake_mcp_list_call: Duration,
    pub(super) path_messages: usize,
    pub(super) tree_messages: usize,
    pub(super) requested_tool_calls: usize,
    pub(super) resolved_tool_results: usize,
    pub(super) deleted_messages: usize,
    pub(super) promoted_children: usize,
    pub(super) truncated_messages: usize,
}

/// Counts and duration from the context-after-tool-chain scenario.
pub(super) struct RuntimeContextBenchmark {
...
pub(super) fn prepare_latest_head_turn(
    store: &mut Store,
...
pub(super) fn pending_latest_head_approvals(
    store: &Store,
    conversation_id: &ConversationId,
...
pub(super) fn deny_latest_head_tool_call(
    store: &mut Store,
    conversation_id: &ConversationId,
...
pub(super) fn benchmark_prepare_head_turn() -> Result<Duration> {
...
pub(super) fn benchmark_pending_tool_approval_scan() -> Result<Duration> {
...
pub(super) fn benchmark_tool_result_insert() -> Result<Duration> {
...
pub(super) fn benchmark_deny_tool_result_persist() -> Result<Duration> {
...
pub(super) fn benchmark_splice_remove() -> Result<(Duration, usize, usize)> {
...
pub(super) fn benchmark_truncate() -> Result<(Duration, usize)> {
...
pub(super) fn benchmark_context_after_tool_chain() -> Result<RuntimeContextBenchmark> {
...
pub(super) fn benchmark_pending_tool_approval_scan_long_path() -> Result<Duration> {
...
pub(super) fn benchmark_pending_tool_approval_scan_deep_chain() -> Result<Duration> {
...
pub(super) fn benchmark_splice_remove_branch_point() -> Result<(Duration, usize, usize)> {
...
pub(super) fn benchmark_splice_remove_root_many_children() -> Result<(Duration, usize, usize)> {
...
pub(super) fn benchmark_splice_remove_tool_group() -> Result<Duration> {
...
pub(super) fn benchmark_truncate_large_subtree() -> Result<(Duration, usize)> {
...
pub(super) fn benchmark_context_plain(message_count: usize) -> Result<Duration> {
...
pub(super) fn benchmark_context_with_system_prompt() -> Result<Duration> {
...
pub(super) fn benchmark_context_with_compaction() -> Result<Duration> {
...
pub(super) fn benchmark_context_with_image_parts() -> Result<Duration> {
...
pub(super) fn benchmark_provider_tool_attach_load() -> Result<Duration> {
