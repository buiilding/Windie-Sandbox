...
pub(crate) fn help_lines() -> Vec<String> {
    vec![
        ...
        "  windie uninstall stops Windie and asks for confirmation before removing Windie-owned files.",
        "  windie uninstall --yes removes Windie-owned files without prompting.",
        "  windie uninstall --dry-run shows the exact cleanup scope without changing anything.",
