...
- Added Codex-shaped file plugins with validated multi-file skills, package
  MCP declarations, content-hash installation, local marketplace metadata,
  and discovery alongside code-owned plugins.
